...
const _sfc_main = {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "supage-content position-relative" }, _attrs))}><h2 class="supage-content__h2">Blog</h2><p>wird hochgeladen...</p></div>`);
    };
  }
};
...
//# sourceMappingURL=blog-CFDEJQDG.mjs.map
