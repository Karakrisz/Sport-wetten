...
import { ssrRenderAttrs } from 'file:///Applications/XAMPP/xamppfiles/htdocs/Sport-wetten/node_modules/vue/server-renderer/index.mjs';
...
const _sfc_main = {
  __name: "sportwetten-tipps",
  __ssrInlineRender: true,
  setup(__props) {
    useHead({
      title: "Sportwetten-Tipps"
    });
    return (_ctx, _push, _parent, _attrs) => {
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "supage-content position-relative" }, _attrs))}><h2 class="supage-content__h2">Sportwetten-Tipps</h2><p>wird hochgeladen...</p></div>`);
    };
  }
};
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("pages/sportwetten-tipps.vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};

export { _sfc_main as default };
//# sourceMappingURL=sportwetten-tipps-Dy-Gl20x.mjs.map
