...
import { defineEventHandler, handleCacheHeaders, splitCookiesString, isEvent, createEvent, fetchWithEvent, getRequestHeader, eventHandler, setHeaders, sendRedirect, proxyRequest, getRequestHost, getRequestProtocol, createError, setResponseHeader, send, getResponseStatus, setResponseStatus, setResponseHeaders, getRequestHeaders, setHeader, getHeader, getQuery as getQuery$1, readBody, lazyEventHandler, useBase, createApp, createRouter as createRouter$1, toNodeListener, getRouterParam, getResponseStatusText } from 'file:///Applications/XAMPP/xamppfiles/htdocs/Sport-wetten/node_modules/h3/dist/index.mjs';
import { getRequestDependencies, getPreloadLinks, getPrefetchLinks, createRenderer } from 'file:///Applications/XAMPP/xamppfiles/htdocs/Sport-wetten/node_modules/vue-bundle-renderer/dist/runtime.mjs';
import { stringify, uneval } from 'file:///Applications/XAMPP/xamppfiles/htdocs/Sport-wetten/node_modules/devalue/index.js';
import destr from 'file:///Applications/XAMPP/xamppfiles/htdocs/Sport-wetten/node_modules/destr/dist/index.mjs';
import { parseURL, withoutBase, joinURL, getQuery, withQuery, withTrailingSlash, hasProtocol, withHttps, withoutProtocol, withLeadingSlash, withBase, withoutTrailingSlash } from 'file:///Applications/XAMPP/xamppfiles/htdocs/Sport-wetten/node_modules/ufo/dist/index.mjs';
import { renderToString } from 'file:///Applications/XAMPP/xamppfiles/htdocs/Sport-wetten/node_modules/vue/server-renderer/index.mjs';
import { hash } from 'file:///Applications/XAMPP/xamppfiles/htdocs/Sport-wetten/node_modules/ohash/dist/index.mjs';
import { renderSSRHead } from 'file:///Applications/XAMPP/xamppfiles/htdocs/Sport-wetten/node_modules/@unhead/ssr/dist/index.mjs';
...
import { consola } from 'file:///Applications/XAMPP/xamppfiles/htdocs/Sport-wetten/node_modules/consola/dist/index.mjs';
import devalue from 'file:///Applications/XAMPP/xamppfiles/htdocs/Sport-wetten/node_modules/@nuxt/devalue/dist/devalue.mjs';
import { getContext } from 'file:///Applications/XAMPP/xamppfiles/htdocs/Sport-wetten/node_modules/unctx/dist/index.mjs';
import { toValue, version, unref } from 'file:///Applications/XAMPP/xamppfiles/htdocs/Sport-wetten/node_modules/vue/index.mjs';
import nodemailer from 'file:///Applications/XAMPP/xamppfiles/htdocs/Sport-wetten/node_modules/nodemailer/lib/nodemailer.js';
import options from 'file:///Applications/XAMPP/xamppfiles/htdocs/Sport-wetten/.nuxt/nuxt-mail/options.mjs';
import send$1 from 'file:///Applications/XAMPP/xamppfiles/htdocs/Sport-wetten/.nuxt/nuxt-mail/send.mjs';
...
import { isAbsolute } from 'file:///Applications/XAMPP/xamppfiles/htdocs/Sport-wetten/node_modules/pathe/dist/index.mjs';
import { createServerHead as createServerHead$1 } from 'file:///Applications/XAMPP/xamppfiles/htdocs/Sport-wetten/node_modules/unhead/dist/index.mjs';
import { defineHeadPlugin } from 'file:///Applications/XAMPP/xamppfiles/htdocs/Sport-wetten/node_modules/@unhead/shared/dist/index.mjs';
...
storage.mount('data', unstorage_47drivers_47fs({"driver":"fs","base":"/Applications/XAMPP/xamppfiles/htdocs/Sport-wetten/.data/kv","ignore":["**/node_modules/**","**/.git/**"]}));
...
const _rTXuMoYrZ6 = (function(nitro) {
  nitro.hooks.hook("render:html", (htmlContext) => {
    htmlContext.head.push(`<script>${script}<\/script>`);
  });
});

const rootDir = "/Applications/XAMPP/xamppfiles/htdocs/Sport-wetten";

const asyncContext = getContext("nuxt-dev", { asyncContext: true, AsyncLocalStorage });
const _NspQUtGLjJ = (nitroApp) => {
...
const _Jmyw84 = defineEventHandler(async (e) => {
  const siteConfig = useSiteConfig(e);
  const nitroOrigin = useNitroOrigin(e);
  const runtimeConfig = useRuntimeConfig(e);
...
const _MZVNvl = defineEventHandler(async (e) => {
...
const _lazy_IWcnsJ = () => Promise.resolve().then(function () { return renderer$1; });

const handlers = [
  { route: '/__nuxt_error', handler: _lazy_IWcnsJ, lazy: true, middleware: false, method: undefined },
  { route: '', handler: _H1x7zM, lazy: false, middleware: true, method: undefined },
  { route: '/__site-config__/debug.json', handler: _Jmyw84, lazy: false, middleware: false, method: undefined },
  { route: '/__sitemap__/debug.json', handler: _MZVNvl, lazy: false, middleware: false, method: undefined },
...
const getClientManifest = () => import('file:///Applications/XAMPP/xamppfiles/htdocs/Sport-wetten/.nuxt/dist/server/client.manifest.mjs').then((r) => r.default || r).then((r) => typeof r === "function" ? r() : r);
const getServerEntry = () => import('file:///Applications/XAMPP/xamppfiles/htdocs/Sport-wetten/.nuxt/dist/server/server.mjs').then((r) => r.default || r);
